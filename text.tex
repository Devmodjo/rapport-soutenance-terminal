...
\end{figure}
 ...
 L’implémentation de notre application de gestion des emplois du temps a été réalisée principalement en Java, avec l’utilisation de JavaFX pour l’interface graphique, SQLite pour la base de données locale, et des bibliothèques externes telles que iTextPDF et Apache POI pour les fonctionnalités d’exportation. Le projet a été développé dans l’IDE Eclipse avec une structure modulaire afin de faciliter la maintenance et les évolutions futures.
